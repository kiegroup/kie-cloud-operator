...
func TestKieServerWithoutEdgeTermination(t *testing.T) {
	...
	checkTLSAndRoute(t, env.Servers[0].Routes[0].Spec.TLS, constants.PassthroughTermination, env.Servers[0].Routes[0])
...
func TestConsoleWithoutEdgeTermination(t *testing.T) {
	...
	env := getAndCheckEnv(t, cr)
	checkTLSAndRoute(t, env.Console.Routes[0].Spec.TLS, constants.PassthroughTermination, env.Console.Routes[0])
...
func TestSmartRouterWithoutEdgeTermination(t *testing.T) {
	...
	env := getAndCheckEnv(t, cr)
	checkTLSAndRoute(t, env.SmartRouter.Routes[0].Spec.TLS, constants.PassthroughTermination, env.SmartRouter.Routes[0])
...
func TestDashbuilderWithoutEdgeTermination(t *testing.T) {
	...
	env := getAndCheckEnv(t, cr)
	checkTLSAndRoute(t, env.Dashbuilder.Routes[0].Spec.TLS, constants.PassthroughTermination, env.Dashbuilder.Routes[0])
