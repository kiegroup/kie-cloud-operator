...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SmartRouterSet) DeepCopyInto(out *SmartRouterSet) {
	*out = *in
	in.KieAppObject.DeepCopyInto(&out.KieAppObject)
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SmartRouterSet.
func (in *SmartRouterSet) DeepCopy() *SmartRouterSet {
	if in == nil {
		return nil
	}
	out := new(SmartRouterSet)
