...
type KieServerSet struct {
	...
	KafkaJbpm   *KafkaJBPMObject `json:"kafkaJbpm,omitempty"`
}
...
// KafkaJBPMObject kafka configuration to be used by the KieApp for JBPM Emitter
type KafkaJBPMObject struct {
