...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KafkaJBPMObject) DeepCopyInto(out *KafkaJBPMObject) {
	*out = *in
	if in.Acks != nil {
		in, out := &in.Acks, &out.Acks
		*out = new(int)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KafkaJBPMObject.
func (in *KafkaJBPMObject) DeepCopy() *KafkaJBPMObject {
	if in == nil {
		return nil
	}
	out := new(KafkaJBPMObject)
	in.DeepCopyInto(out)
	return out
}
...
func (in *KieServerSet) DeepCopyInto(out *KieServerSet) {
	*out = *in
	...
	if in.KafkaJbpm != nil {
		in, out := &in.KafkaJbpm, &out.KafkaJbpm
		*out = new(KafkaJBPMObject)
		(*in).DeepCopyInto(*out)
	}
	return
