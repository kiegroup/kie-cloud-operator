...
function help()
{
    ...
    echo
    echo "Run a cekit osbs build of an bamoe ba operator image with bundle"
    echo
    ...
    echo "  -d CEKIT_OSBS_SUBDIR      The cekit local directory for the OSBS content (on Jenkins it should be /home/jenkins/.cekit/osbs/containers/ibm-bamoe-operator)"
