...
operator-courier push deploy/catalog_resources/courier/bundle_dir/1.2.1 ${REGISTRY_NS} kiecloud-operator 1.2.1 "basic XXXXXXXXX"
# operator-courier push deploy/catalog_resources/courier/bundle_dir/1.2.0 ${REGISTRY_NS} kiecloud-operator 1.2.0 "basic XXXXXXXXX"
```
